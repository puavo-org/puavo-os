...
ZIP=/tmp/gtk+-3.24.5.zip
DEVZIP=/tmp/gtk+-dev-3.24.5.zip
...
mkdir -p share/doc/gtk+-3.24.5
cp -p /state/adm-home/adm-juhaerk/src/gtk/gtk+3.0-3.24.5/debian/build/udeb/../../../COPYING share/doc/gtk+-3.24.5

mkdir -p share/doc/gtk+-dev-3.24.5
cp -p /state/adm-home/adm-juhaerk/src/gtk/gtk+3.0-3.24.5/debian/build/udeb/../../../COPYING share/doc/gtk+-dev-3.24.5
...
zip -r -D $ZIP share/doc/gtk+-3.24.5
...
zip -r $DEVZIP share/doc/gtk+-dev-3.24.5
