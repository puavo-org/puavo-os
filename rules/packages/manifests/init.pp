class packages {
  ...
  $nvidia_dkms_410_module   = 'nvidia-current/418.226.00'
  $r8168_module             = 'r8168/8.046.00'
  $virtualbox_module        = 'virtualbox/6.1.38'
  ...
  packages::kernels::kernel_package {
    '4.19.0-21-amd64':
      ...
      package_name => 'linux-image-4.19.0-21-amd64';

    '5.10.0-0.deb10.17-amd64':
      dkms_modules => [ $broadcom_sta_dkms_module
                      , $virtualbox_module ],
      package_name => 'linux-image-5.10.0-0.deb10.17-amd64-unsigned';
  }
