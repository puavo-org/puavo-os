class packages {
  ...
  $nvidia_dkms_470_module   = 'nvidia-current/470.256.02'
  $r8168_module             = 'r8168/8.050.03'
  $virtualbox_module        = 'virtualbox/7.0.26'
  ...
  packages::kernels::kernel_package {
    '5.10.0-35-amd64':
      ...
      package_name => 'linux-image-5.10.0-35-amd64';
    ...
    '6.1.0-0.deb11.37-amd64':
      dkms_modules => [ $broadcom_sta_dkms_module
                      , $virtualbox_module ],
      package_name => 'linux-image-6.1.0-0.deb11.37-amd64-unsigned';
  }
