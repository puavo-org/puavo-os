class packages {
  ...
  $nvidia_dkms_535_module   = 'nvidia-current/535.261.03'
  ...
  packages::kernels::kernel_package {
    '6.1.0-52-amd64':
      ...
      package_name => 'linux-image-6.1.0-52-amd64';

    '6.12.100+deb12.1-amd64':
      ...
      # debian-fasttrack.
      dkms_modules => [],
      package_name => 'linux-image-6.12.100+deb12.1-amd64-unsigned';
  }
