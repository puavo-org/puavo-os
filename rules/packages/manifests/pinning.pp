...
# XXX Disable this for now.  There are issues with pinning, with package
# XXX conflicts, and hopefully upstream (NVIDIA) solves the issues before
# XXX Stretch is ready for production.
