...
import { SwitchRow, AdjustmentRow, Group, fixPageScrollIssue, RgbColorRow, DropdownRow, EntryRow, Dialog, PaddingDialog, } from "../libs/prefs/components.js";
function SliderCustomizes({ settings, baseName, sensitiveBind, }) {
	...
	const updateHandleOptionVisibleConnection = settings.connect(`changed::${baseName}-style`, updateHandleOptionVisible);
