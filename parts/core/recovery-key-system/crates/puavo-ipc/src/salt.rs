...
mod tests {
    ...
    pub fn generate_device_salt_with_source(
        ...
        let source = DeviceSaltSource::new(serial_number);
    ...
    fn test_device_salt_source_creation() {
        ...
        let source1 = DeviceSaltSource::new(serial_number.clone());
        let source2 = DeviceSaltSource::new(serial_number.clone());
    ...
    fn test_different_sources_produce_different_salts() {
        let (source1, salt1) =
            generate_device_salt_with_source("DEVICE-001".to_string(), None)
                .unwrap();
        let (source2, salt2) =
            generate_device_salt_with_source("DEVICE-002".to_string(), None)
                .unwrap();
