...
static ENGLISH_STRINGS: Strings = Strings {
    ...
    pin_too_short: "PIN is too short, use at least 6 characters",
...
static FINNISH_STRINGS: Strings = Strings {
    ...
    pin_too_short: "PIN-koodi on liian lyhyt, käytä vähintään 6 merkkiä",
...
static SWEDISH_STRINGS: Strings = Strings {
    ...
    pin_too_short: "PIN-koden är för kort, använd minst 6 tecken",
...
static GERMAN_STRINGS: Strings = Strings {
    ...
    pin_too_short: "PIN ist zu kurz, mindestens 6 Zeichen verwenden",
